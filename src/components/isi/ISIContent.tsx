    ...
    <div className="bg-white text-black p-6">
      ...
      <div className="grid grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
            <h3 className="text-[16px] font-medium text-gray-800">ISI Score</h3>
          </div>
          <div className="p-4">
            <div className="flex flex-col 2xl:flex-row 2xl:items-center 2xl:justify-between gap-4">
                <div>
                  ...
                  <div className={`inline-flex items-center px-2 py-1 rounded-full text-[14px] font-medium ${getISIBadgeColor(displayScore)}`}>
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
            <h3 className="text-[16px] font-medium text-gray-800">Strategic Signal</h3>
          </div>
          <div className="p-4">
            <>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className={`inline-flex items-center px-2 py-1 rounded-full text-[14px] ${dominantSentiment.badge}`}>
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
            <h3 className="text-[16px] font-medium text-gray-800">Sentiment Pulse</h3>
          </div>
          <div className="p-4">
            <>
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="text-[14px] text-black">Based on last 30 days</div>
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-[0.65] space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
            <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
              <div className="grid grid-cols-3 gap-4 text-sm font-semibold text-[#1E1E1E]">
                ...
                {!features.hasNLGNarrative ? (
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center space-x-2 ">
                        <span className={`text-sm px-3 py-1 rounded-full ${aiBrief.confidence === 'High Confidence' ? 'text-green-600 bg-[#ECFDF3] border border-[#CDEEE0] ' : 'text-yellow-600 bg-[#FFF4DB] border border-[#FFE8A1]'}`}>
                          {aiBrief.confidence}
                        </span>
                    ...
                    <div className="space-y-4">
                      <div>
                        <h5 className="font-[600] text-[#1E1E1E]  text-[16px] mb-2 flex items-center">
                      ...
                      <div>
                        <h5 className="font-[600] text-black mb-2 flex items-center">
